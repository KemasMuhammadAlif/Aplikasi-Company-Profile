            ...
            <div class="modal-body-custom">
                <form action="{{ route('admin.sertifikat.store') }}" method="POST">
                    ...
                    <div class="form-group-custom">
                        ...
                        <input type="text" name="sertifikat" class="form-input-custom"
                    ...
                    <div class="form-group-custom">
                        ...
                        <div class="icon-grid">
                            @php
                            $certIcons = [
                            'bi-patch-check', 'bi-award', 'bi-diagram-3',
                            'bi-shield-check', 'bi-clipboard-check', 'bi-check-circle',
                            'bi-star', 'bi-trophy', 'bi-bookmark-check',
                            'bi-file-earmark-check', 'bi-person-check', 'bi-building',
                            ];
                            @endphp
