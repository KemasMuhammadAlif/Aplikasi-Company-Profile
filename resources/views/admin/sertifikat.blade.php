    ...
    <div class="cert-grid">
        ...
        @forelse ($certificates as $cert)
            <a href="#" class="cert-card">
                ...
                <div class="cert-cat-label">{{ $cert['category'] }}</div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-add-cert">
            <div class="modal-content-custom">
                ...
                <div class="modal-header-custom">
                    <div>
                        <div class="modal-eyebrow">System Command</div>
                ...
                <div class="modal-body-custom">
                    <form action="{{ route('admin.sertifikat.store') }}" method="POST" id="formAddCertificate">
                        @csrf

                        {{-- Certificate Name --}}
                        <div class="form-group-custom">
                            <label class="form-label-custom" for="certName">
                                Nama Sertifikat
                            </label>
                            <input type="text" id="certName" name="title" class="form-input-custom"
                            ...
                            <div class="icon-grid">
                                ...
                                @foreach ($certIcons as $icon)
                                    <button type="button" class="icon-option {{ $loop->first ? 'selected' : '' }}"
                                        data-icon="{{ $icon }}" onclick="selectCertIcon(this)" title="{{ $icon }}">
                                        <i class="bi {{ $icon }}"></i>
                                    </button>
                                @endforeach
                            </div>
...
@push('scripts')
    <script>
        function selectCertIcon(el) {
            document.querySelectorAll('.icon-option').forEach(btn => {
                btn.classList.remove('selected');
            });
            el.classList.add('selected');
            document.getElementById('selectedCertIcon').value = el.dataset.icon;
        }
    </script>
@endpush