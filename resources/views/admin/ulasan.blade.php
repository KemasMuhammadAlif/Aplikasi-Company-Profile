    ...
    <div class="ulasan-grid">
        ...
        @forelse ($ulasans as $ulasan)
            <div class="ulasan-card"
                data-search="{{ strtolower($ulasan->text_testimoni . ' ' . $ulasan->nama_klien . ' ' . $ulasan->nama_perusahaan) }}">
                ...
                <div class="ulasan-card-header">
                    ...
                    <span class="ulasan-header-label">Ulasan A</span>
                </div>

                {{-- Card Body --}}
                <div class="ulasan-card-body">
                    <p class="ulasan-text">
                        {{ $ulasan->text_testimoni ?? 'To become the global cornerstone of industrial innovation, bridging the gap between traditional...' }}
                    </p>
                </div>
                ...
                <div class="ulasan-card-footer">
                    {{-- Balas --}}
                    <button class="ulasan-reply-btn" onclick="openBalasUlasan('{{ $ulasan->id_testimoni }}')">
                        <i class="bi bi-reply"></i>
                        Balas
                    </button>

                    {{-- Hapus --}}
                    <button class="ulasan-delete-btn" onclick="openHapusUlasan('{{ $ulasan->id_testimoni }}')">
...
@push('scripts')
    <script>
        function openBalasUlasan(id) {
            document.getElementById('balas_id_testimoni').value = id;
            document.getElementById('balas_text').value = '';
