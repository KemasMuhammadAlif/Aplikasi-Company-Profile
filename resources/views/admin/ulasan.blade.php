...
<div class="ulasan-grid">
    ...
    <div class="ulasan-card">
        ...
        <div class="ulasan-card-body">
            ...
            @if($ulasan->balasan)
            <div style="margin-top:12px;padding:10px 14px;background:#f0f6ff;border-left:3px solid #2563eb;border-radius:0 8px 8px 0;">
                <div style="font-size:10px;font-weight:700;color:#2563eb;letter-spacing:1px;text-transform:uppercase;margin-bottom:6px;">
        ...
        <div class="ulasan-card-footer">
            ...
            <div class="ulasan-footer-actions">
                {{-- Balas --}}
                <button class="ulasan-reply-btn"
                    onclick="openBalasUlasan(
                '{{ $ulasan->id_review }}',
                ...
                {{-- Hapus --}}
                <button class="ulasan-delete-btn"
                    onclick="openHapusUlasan('{{ $ulasan->id_review }}')">
