...
@section('content')
    ...
    <div class="profil-top-grid">
        ...
        {{-- ADD NEW PROFIL --}}
        <a href="#" class="add-profil-card"
           data-bs-toggle="modal" data-bs-target="#modalAddProfil">
        ...
        <div class="statement-card">
            ...
            <div class="statement-card-footer">
                <button class="stmt-icon-btn"
                    onclick="openEditProfil('visi', '{{ addslashes($profil->visi ?? '') }}')">
                    <i class="bi bi-pencil"></i>
                </button>
                <button class="stmt-icon-btn stmt-danger"
                    onclick="openDeleteProfil('visi')">
        ...
        <div class="statement-card">
            ...
            <div class="statement-card-footer">
                <button class="stmt-icon-btn"
                    onclick="openEditProfil('misi', '{{ addslashes($profil->misi ?? '') }}')">
                    <i class="bi bi-pencil"></i>
                </button>
                <button class="stmt-icon-btn stmt-danger"
                    onclick="openDeleteProfil('misi')">
                    <i class="bi bi-trash"></i>
                </button>
            </div>
        </div>
                    ...
                    <form action="{{ route('admin.profil.store') }}" method="POST" id="formAddProfil">
                        ...
                        <div class="form-group-custom">
                            ...
                            <div class="profil-select-wrap">
                                <select
                                    name="jenis"
                                    id="profilJenisSelect"
                                    class="form-input-custom profil-select"
                ...
                <div class="modal-body-custom">
                    <form id="formEditProfil" action="{{ route('admin.profil.update') }}" method="POST">
                        ...
                        <div class="form-group-custom">
                            ...
                            <textarea name="value" id="editProfilValue"
                                class="form-input-custom form-textarea-custom"
                                rows="5"></textarea>
                        </div>
...
<style>
    ...
    .add-profil-card:hover { border-color: #2563eb; background: #f0f6ff; }
    ...
    .add-profil-card:hover .add-profil-icon { background: #dbeafe; color: #2563eb; }
    ...
    .vision-badge  { background: #eff6ff; color: #2563eb; }
    .mission-badge { background: #fff7ed; color: #f97316; }

    .statement-type-label {
        font-size: 9.5px; font-weight: 800;
        letter-spacing: 1.1px; text-transform: uppercase; color: #64748b;
    }
    ...
    .stmt-icon-btn:hover { background: #eff6ff; color: #2563eb; border-color: #93c5fd; }
    .stmt-danger:hover   { background: #fee2e2; color: #dc2626; border-color: #fecaca; }
    ...
    .history-header-title {
        ...
        letter-spacing: 1.1px; text-transform: uppercase; color: #374151;
    }

    /* Toolbar */
    .history-toolbar { display: flex; gap: 4px; }
    ...
    .history-editor p { margin-bottom: 12px; }
    .history-editor p:last-child { margin-bottom: 0; }
    ...
    .btn-simpan {
        height: 36px; padding: 0 22px; border: none;
    ...
    .btn-simpan:hover { background: #1d4ed8; box-shadow: 0 4px 14px rgba(37,99,235,0.30); }
    ...
    .modal-header-custom {
        background: #1a2236; padding: 20px 24px;
    ...
    .modal-eyebrow {
        ...
        color: #6b89c0; margin-bottom: 4px;
    }
    ...
    .modal-close-btn {
        ...
        display: flex; align-items: center; justify-content: center;
        font-size: 14px; cursor: pointer; flex-shrink: 0; margin-top: 2px;
        transition: background 0.15s, color 0.15s;
    }

    .modal-close-btn:hover { background: rgba(255,255,255,0.18); color: #fff; }

    .modal-body-custom { background: #fff; padding: 24px 24px 26px; }

    .form-group-custom { margin-bottom: 20px; }

    .form-label-custom {
        display: block; font-size: 10.5px; font-weight: 700;
        letter-spacing: 0.9px; color: #64748b; margin-bottom: 8px;
    }
    ...
    .form-textarea-custom { height: auto; padding: 11px 14px; resize: none; line-height: 1.55; }
    ...
    .btn-modal-submit:hover { background: #1d4ed8; box-shadow: 0 4px 14px rgba(37,99,235,0.30); }
    ...
    /* Responsive */
    @media (max-width: 900px) { .profil-top-grid { grid-template-columns: 1fr 1fr; } }
    @media (max-width: 580px) { .profil-top-grid { grid-template-columns: 1fr; } }
</style>
@endpush
