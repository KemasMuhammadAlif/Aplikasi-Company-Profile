...
<div class="services-grid">
    ...
    {{-- Tombol Add --}}
    <a href="{{ route('admin.faq.create') }}" class="add-service-card">
    ...
    <div class="service-card">
        ...
        <div class="d-flex gap-2 mt-auto">
            ...
            <form method="POST" action="{{ route('admin.faq.destroy', $faq->id_faq) }}" class="w-100">
                @csrf
                @method('DELETE')
                <button type="submit" onclick="return confirm('Hapus FAQ ini?')"
    ...
    <div class="text-muted" style="grid-column:1/-1;padding:40px 0;text-align:center;font-size:14px;">
        Belum ada FAQ. Klik "Add New FAQ" untuk memulai.
    </div>
    @endforelse
